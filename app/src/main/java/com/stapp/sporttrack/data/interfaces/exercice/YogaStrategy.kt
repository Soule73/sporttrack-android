...
class YogaStrategy : ExerciseStrategy {
    ...
    override fun getTitle() = R.string.exercise_yoga
    override fun getIcon() = R.drawable.ic_yoga_marker
    override fun getImage() = R.drawable.exercise_yoga_image
    private val metValue = 3.0 // MET pour le yoga
