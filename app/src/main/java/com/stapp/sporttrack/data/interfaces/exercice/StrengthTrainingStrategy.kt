...
class StrengthTrainingStrategy : ExerciseStrategy {
    ...
    override fun getTitle() = R.string.exercise_strength_training
    override fun getIcon() = R.drawable.ic_strength_marker
    override fun getImage() = R.drawable.exercise_strength_training_image
    private val metValue = 6.0 // MET pour la musculation
    ...
    override fun updateExerciseStats(
        weightInKg: Double?,
        elapsedTime: Long,
        totalDistance: Double, // 0 pour la musculation
        stepCount: Int, // non pertinent
        lastLocation: LatLng?,
        newLocation: LatLng?
    ): ExerciseStats {
